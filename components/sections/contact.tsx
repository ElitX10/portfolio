    ...
    <section id="contact" className="border-t border-border/40 py-20 sm:py-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <header className="mb-14 md:mb-20">
          ...
          <h2 className="mt-2 text-3xl font-bold tracking-tight sm:text-4xl">On se rencontre ?</h2>
          <p className="mt-4 max-w-xl text-base text-muted-foreground">
            Toujours partant pour discuter d&apos;un nouveau projet, d&apos;une opportunité ou
            simplement échanger sur la tech.
          </p>
        </header>
